...
#define BUILD_VARIANT_LABEL "a34x-A346EXXUEFZE6-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "a34x-A346EXXUEFZE6-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/a34xdxx/a34x:16/BP4A.251205.006/A346EXXUEFZE6:user/release-keys"
#endif
...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x0014ba2cULL
...
#define P0_FINGERPRINT_HEADER \
  "targets/a34x-A346EXXUEFZE6/p0_fingerprint.h"
#endif
...
/* A346EXXUEFZE6 offsets. */
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00a41158ULL
#define NOOP_LLSEEK_OFF 0x010ba3c0ULL
#define COPY_SPLICE_READ_OFF 0x0029dc84ULL
#define CONFIGFS_READ_ITER_OFF 0x00a8ce4cULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x00a8d378ULL
#define ASHMEM_IOCTL_OFF 0x003915f0ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x010dc778ULL
#define ASHMEM_MMAP_OFF 0x00391d80ULL
#define ASHMEM_OPEN_OFF 0x00391fb0ULL
#define ASHMEM_RELEASE_OFF 0x00392038ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x003920c4ULL
#define ANON_PIPE_BUF_OPS_OFF 0x0122b988ULL
#define ASHMEM_FOPS_OFF 0x013c3ef8ULL
#define KMALLOC_CACHES_OFF 0x017c3df0ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x0235ae60ULL
#define INIT_TASK_OFF 0x0236e340ULL
#define ROOT_TASK_GROUP_OFF 0x0257bd80ULL
#define SELINUX_ENFORCING_OFF 0x025be600ULL
#define SYSCTL_BOOTID_OFF 0x026a11e0ULL
#define ASHMEM_MISC_OFF 0x024dc3a0ULL
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x017462a1ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x02362278ULL
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x02499138ULL
