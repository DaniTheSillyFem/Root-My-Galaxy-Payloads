...
| `r12s-S721BXXSDZG1` | Galaxy S24 FE `SM-S721B` | `6.1.157` | Build complete; hardware execution pending|
...
| `a34x-A346EXXSDEZB6` | Galaxy A34 5G `SM-A346E` | `6.6.82` | Build complete; hardware execution pending |
| `a34x-A346EXXUEFZE6` | Galaxy A34 5G `SM-A346E` | `6.6.92` | Build complete; hardware execution pending |
...
make TARGET=r12s-S721BXXSDDZG1 ANDROID_NDK_HOME=/path/to/android-ndk
...
make TARGET=a34x-A346EXXSDEZB6 ANDROID_NDK_HOME=/path/to/android-ndk
make TARGET=a34x-A346EXXUEFZE6 ANDROID_NDK_HOME=/path/to/android-ndk
```
...
The SM-A346E EZB6 analysis record is in
[`docs/SM-A346E-A346EXXSDEZB6.md`](docs/SM-A346E-A346EXXSDEZB6.md).
